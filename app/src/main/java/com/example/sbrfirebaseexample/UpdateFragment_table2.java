 ...
 */
public class UpdateFragment_table2 extends Fragment {
    EditText editText1,editText2,editText3,editText4;
    Button upbutton;
    public UpdateFragment_table2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_update_table2, container, false);
        ...
        upbutton = view.findViewById(R.id.updatesupplier);
        upbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.myAppDatabase.myDao().updateSuppliers(supplier);
