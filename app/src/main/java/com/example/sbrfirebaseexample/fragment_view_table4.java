 ...
 */
public class fragment_view_table4 extends Fragment {
    TextView textView;

    private ListView list = null;
    public fragment_view_table4() {
    ...
    public void RefreshData()
    {
        CollectionReference collectionReference = MainActivity.db.
                collection("Sales");
        Query query = collectionReference.orderBy("item_id", Query.Direction.ASCENDING);
